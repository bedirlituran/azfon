...
export default function Packages() {
  return (
    ...
    <div className="bg-linear-to-br from-gray-100 via-white to-gray-200 text-gray-900">
       <section className="max-w-6xl mx-auto px-6 py-20 cursor-pointer ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
        {packages.map((pkg) => (
          <div
            key={pkg.id}
            className="relative bg-linear-to-b from-white to-slate-50 rounded-3xl border border-gray-200 shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 p-10 flex flex-col items-center text-center"
          >
            {pkg.note && (
